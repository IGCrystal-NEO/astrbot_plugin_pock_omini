    ...
    def _ensure_config(self):
        if not os.path.exists(self.config_path):
            default = {
                ...
                "llm_prompt_template": "{username} 在{chat_type}戳了你，已经戳了{count}次，请你回复一下，回复要确保符合人设，考虑上下文，确保通顺不突兀。"
            }
    ...
    def _load_config(self):
        try:
            ...
            self.llm_prompt_template = cfg.get(
                'llm_prompt_template',
                "{username} 在{chat_type}戳了你，已经戳了{count}次，请你回复一下，回复要确保符合人设，考虑上下文，确保通顺不突兀。"
            )
            ...
            self.llm_prompt_template = "{username} 在{chat_type}戳了你，已经戳了{count}次，请你回复一下，回复要确保符合人设，考虑上下文，确保通顺不突兀。"
